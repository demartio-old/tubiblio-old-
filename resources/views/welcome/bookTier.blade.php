        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active">Autor</li>
              <li data-filter=".filter-app">Libro</li>
{{--              <li data-filter=".filter-card">Mes</li>--}}
{{--              <li data-filter=".filter-web">Día</li>--}}
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active">Siempre</li>
              <li data-filter=".filter-app">Año</li>
              <li data-filter=".filter-card">Mes</li>
              <li data-filter=".filter-web">Día</li>
            </ul>
          </div>
