...
{{--              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore--}}
              ...
              <div class="row">
                ...
                <ul>
                    ...
                    <li><i class="icofont-rounded-right"></i> <strong>Author:</strong> {{ $book->author }}</li>
                    <li><i class="icofont-rounded-right"></i> <strong>Género: </strong> {{ $book->category }}</li>
                  ...
                  <div class="col-lg-6">
                <ul>
                <li><i class="icofont-rounded-right"></i> <strong>1ª Edición: </strong>{{ $book->r_date }}</li>
                <li><i class="icofont-rounded-right"></i> <strong>Agregado por: </strong> 30</li>
{{--                <li><i class="icofont-rounded-right"></i> <strong>Ultima edición: </strong>{{ $book->r_date }}</li>--}}
